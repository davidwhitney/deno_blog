...
Deno.test("module exports expected dependencies", () => {
    ...
    assert(module.blog.createBlogHandler, "module.blog.createBlogHandler is not defined");
    ...
    assert(module.components.PostPage, "module.components.PostPage is not defined");
});